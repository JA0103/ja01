...
insert into member_tbl values(mem_seq.nextval,'이축복','010-1111-3333', '서울 동대문구 휘경2동', '20151206', 'B', '01');
insert into member_tbl values(mem_seq.nextval,'장믿음', '010-1111-4444', '울릉군 울릉읍 독도1리','20151001', 'B', '30');
insert into member_tbl values(mem_seq.nextval,'최사랑', '010-1111-5555', '울릉군 울릉읍 독도2리', '20151113', 'A', '30');
insert into member_tbl values(mem_seq.nextval,'진평화', '010-1111-6666', '제주도 제주시 외나무골', '20151225', 'B', '60');
insert into member_tbl values(mem_seq.nextval,'차공단', '010-1111-7777', '제주도 제주시 감나무골', '20151211', 'C','60');
...
--번호,이름,등급,매출
--member_tbl: custno,custname,grade   money_tbl: price

select A.custno,A.custname,A.grade,sum(price)
from member_tbl A, money_tbl G
where A.custno = G.custno
