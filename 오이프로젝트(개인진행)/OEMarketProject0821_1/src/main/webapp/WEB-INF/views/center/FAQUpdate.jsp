...
<section id="FAQUpdate">
	<form action="/center/FAQUpdate" method="post">
		...
		<div class="container">
			<div class="row form-group">
				<div class="col-md-auto center__insert__label"><p class="h4 font-weight-bold"><label for="no_tilte">제목　</label></p></div>
				<div class="col-md-auto">
					<input type="text" name="no_title" class="form-control center__insert__input" id="no_tilte"
			...
			<div class="col-md-auto form-group">
				<textarea name="no_content" class="form-control center__insert__textarea" id="no_content" rows="14" cols="100"
