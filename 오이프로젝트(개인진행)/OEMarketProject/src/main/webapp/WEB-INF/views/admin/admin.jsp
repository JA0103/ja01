		...
		<div class="admin_user_list">
			<div class="col-lg-12">
				<div class="inner-content">
					<table>
						<thead>
							<th class="admin_head_"><a href="admin/boardListOrderByRegdate?align=regdate">아이디</a></th>
							<th class="admin_head_">닉네임</th>
							<th class="admin_head_">이름</th>
							<th class="admin_head_">가입일</th>
							<th class="admin_head_">게시글 수</th>
							<th class="admin_head_">${align}</th>
						</thead>
						<tbody>
							<c:forEach items="${ad_user}" var="ad_user">
								<tr>
									<th><c:out value="${ad_user.us_id}" /></th>
									<th><c:out value="${ad_user.us_nickname}" /></th>
									<th><c:out value="${ad_user.us_name}" /></th>
									<th><c:out value="${ad_user.us_joindate}" /></th>
									<th><c:out value="${ad_user.us_boardCnt}" /></th>
									<th><c:out value="${ad_user.us_replyCnt}" /></th>
								</tr>
							</c:forEach>
						</tbody>
					</table>
