			...
			<div class="row">
				<div class="col-6">
					<p class="h6"><a href="/center/center?us_id=${login.us_id}">고객센터</a>
						>
					<a href="/center/SuggestInsert?us_id=${login.us_id}">건의하기</a></p>
				</div>
			</div>
		</div>
	</div>
...
<form action="/center/SuggestInsert" method="post" enctype="multipart/form-data">
	   ...
	   $(document).ready(function(){
		      ...
		      //모달-----------------------안내창----------------------------  
		       ...
		       $("#submitBtn").on("click",function(){
			    	   modal.find("p").text("등록 후 수정이 불가능합니다.");
