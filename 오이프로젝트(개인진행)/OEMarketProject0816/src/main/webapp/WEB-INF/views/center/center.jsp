						...
						<div class="col-6">
							<div class="card mb-3" style="width: 540px; height: 210px; margin-left: -15px; cursor: pointer;">
								<div class="row no-gutters">
									...
									<div class="col-md-8">
										<div class="card-body" style="padding: 30px;" onclick="location.href='/center/QnAInsert'">
						...
						<div class="col-6">
							<div class="card mb-3" style="width: 540px; height: 210px; cursor: pointer;">
								<div class="row no-gutters">
									...
									<div class="col-md-8">
										<div class="card-body" style="padding: 30px;" onclick="location.href='/center/suggestInsert'">
