...
<section class="center__insert__ce" id="QnAInsert">
	<div class="center__header__bottom">
		<p class="h6"><a href="/center/center">고객센터</a>&nbsp;&nbsp;＞&nbsp;&nbsp;<a href="/center/QnAInsert">1:1 문의하기</a></p>
	</div>
	<div class="container center__insert__title">
		<div class="row"><div class="col-12"><p class="h2"><strong>1:1 문의하기</strong></p></div></div>
	</div>
		<input type="hidden" name="us_id" id="us_id" value="${login.us_id}">
	<form action="/center/QnAInsert" method="post" enctype="multipart/form-data" name="form">
		<input type="hidden" name="ce_id" id="ce_id" value="${login.us_id}">
		<input type="hidden" name="ce_nickname" id="ce_nickname" value="${login.us_nickname}">
		...
		<div class="container">
			...
			<div class="row form-group">
				<div class="col-md-auto center__insert__label"><p class="h4 font-weight-bold"><label for="ce_email">이메일</label></p></div>
				<div class="col-md-auto">
					<input type="text" name="ce_email" class="form-control center__insert__input" id="ce_email" placeholder="답변 받을 이메일 주소를 정확하게 입력해주세요.">
				</div>
			</div>
			...
			<div class="col-md-auto form-group">
				<textarea name="ce_content" class="form-control center__insert__textarea" id="ce_content" placeholder="1000자 이내로 입력해주세요." rows="10"></textarea>
			</div>
		</div>
		<div class="container">
			<div class="row center__savearea">
				...
				<div class="col-auto">
					<div class="offset-md-auto center__buttonarea">
						...
						<button type="button" class="btn btn-secondary"  onclick="location.href='/center/QnA?us_id=${login.us_id}'">1:1 문의 내역으로</button>
				  	</div>
				</div>
			</div>
		</div>
		      ...
		      //모달 안내창===================================================  
		       ...
		       $("#submitBtn").on("click",function(){
		     	   ...
		     	   if(document.form.ce_title.value.length === 0){
						...
						return false;
					}else if(document.form.ce_email.value.length === 0){
						alert("이메일을 입력해주세요.");
						...
						return false;
					}else if(document.form.ce_id.value.length === 0){
						alert('재로그인 후 이용바랍니다.');
						$(location).attr("href","/login");
					}
		    	   
			    	   modal.find("p").text("등록 후 수정 및 삭제가 불가능합니다. 계속하시겠습니까?");
