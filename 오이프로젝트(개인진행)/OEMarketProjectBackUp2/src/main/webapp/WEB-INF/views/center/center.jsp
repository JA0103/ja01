...
<section id="centerMainpage">
	<div class="center__header__bottom">
		<p class="h6"><c:choose>
			<c:when test="${us_id != null }"><strong onclick="location.href='/center/notice?us_id=<c:out value="${us_id }"/>'">공지사항</strong></c:when>
			<c:otherwise><strong onclick="location.href='/center/notice'">공지사항</strong></c:otherwise>
			...
			<c:when test="${us_grade == 0 }">
				...
				<div class="container" style="padding-top: 15px; padding-bottom: 40px;">
					<div class="row card-group">
						...
						<div class="card mb-3 card__admin" onclick="location.href='/center/suggest_admin'">
