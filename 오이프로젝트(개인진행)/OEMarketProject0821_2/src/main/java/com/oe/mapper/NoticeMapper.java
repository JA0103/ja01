...
public interface NoticeMapper {
	...
	public void updateNotice(NoticeVO vo); //공지 수정
	public void updateFAQ(NoticeVO vo); //도움말 수정
	
	public void deleteNotice(int no_num); //공지 삭제
	public void deleteFAQ(int no_num); //도움말 삭제
}
