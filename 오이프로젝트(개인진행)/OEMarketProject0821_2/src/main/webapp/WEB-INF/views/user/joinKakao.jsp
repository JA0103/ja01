            ...
            <div class="col-md-6 col-lg-5">
               <div class="insert-wrap">
                  ...
                  <form role="form" action="/user/join" method="post" name="form">
                     <input type="hidden" readonly="readonly" name="us_id" value='<c:out value="${us_id }"/>'>
                     <h1>회원가입</h1><br>
                     <div class="form-group join_id">
                        <input type="text" class="form-control"  readonly="readonly" value='<c:out value="${us_id }"/>' >
                     </div>
                     <div class="form-group join_pass">
                        <input type="password" readonly="readonly" name="us_pass" 
                           placeholder="${us_pass }" class="form-control" >
                     </div>
                     ...
                     <div class="form-group">
                        <input type="text" name="us_name" value='<c:out value="${us_name }"/>' class="form-control" >
                     </div>
                     <div class="form-group">
