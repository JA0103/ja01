...
//	@GetMapping({ "login.do", "board/login.do" })
	...
	public String kakaoCallback(String code, HttpSession session, RedirectAttributes rttr, HttpServletRequest request) {
...
//			vo.setUs_phone("010-0000-0000");
			String uskakao_id = kakaoProfile.getId();
			log.info("======================kakaoProfile.getId()"+uskakao_id);
			log.info("======================userService.getId(uskakao_id)"+userService.getId(uskakao_id));
