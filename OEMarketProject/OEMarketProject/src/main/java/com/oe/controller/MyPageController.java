...
public class MyPageController {
   private MyPageService service;
	...
	/*
	 * @GetMapping("/NewFile") public void get2(String my_id, Model model) {
	 * log.info("get2------------------");
	 * model.addAttribute("sellCount",service.sellCount(my_id));
	 * model.addAttribute("mypage", service.get(my_id)); model.addAttribute("user",
	 * service.getUserInfo(my_id)); model.addAttribute("countingHeart",
	 * service.getmyCountHB(my_id)); log.info(my_id);
   ...
   public String profileEdit(MyPageVO vo, RedirectAttributes rttr, MultipartHttpServletRequest mtfRequest) {
