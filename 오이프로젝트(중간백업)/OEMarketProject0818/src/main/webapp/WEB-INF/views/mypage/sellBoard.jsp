							...
							<c:forEach items="${sell}" var="sellList" varStatus="status">
								...
								<tr>
									...
									<td scope="row" width="20%">
										...
										onclick="location.href='/board/boardDetail?bo_num=${sellList.bo_num}&align=regdate'">
											<img src="<spring:url value='/img/${sellList.bo_image}'/>"
												width="40%" height="10%">
											<c:out value="${sellList.bo_title}" />
										</div>
									</td>
