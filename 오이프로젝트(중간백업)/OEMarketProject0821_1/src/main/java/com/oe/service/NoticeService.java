...
public interface NoticeService {
	...
	public void modifyNotice(NoticeVO vo); //공지 수정
	public void modifyFAQ(NoticeVO vo); //도움말 수정
	
	public void removeNotice(Integer no_num); //공지 삭제
	public void removeFAQ(Integer no_num); //도움말 삭제
}
