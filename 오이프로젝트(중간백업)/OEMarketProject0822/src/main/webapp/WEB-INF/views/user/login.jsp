...
<body>
					...
					<div class="login-wrap">
						...
						<form action="${contextPath}/loginUser" class="login-form" method="post">
							...
							<div class="form-group social d-flex text-center naver">
								<a href="https://nid.naver.com/oauth2.0/authorize?client_id=TCx4k7afmZwGpAwezMhY&response_type=code&redirect_uri=http://localhost:8080/naverLogin"
								 ><img src="/resources/assets/images/unnamed.png"> 네이버로 로그인하기</a>
							</div>
    ...
    <script>
      ...
      //네이버===============================================================
      //네이버 로그인 연동 api 
      //Client Secret :dHqiBpogA9
      
/*       
      var naverLogin = new naver.LoginWithNaverId(
    			{
    				clientId: "TCx4k7afmZwGpAwezMhY", //내 애플리케이션 정보에 cliendId를 입력해줍니다.
